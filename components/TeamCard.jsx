  ...
  return (
    <div className="md:w-[35rem] w-[18rem] bg-gray-100 dark:bg-gray-900 md:h-[18rem] -px-16 h-[25rem] mx-auto rounded-2xl mt-10">
      <section className="flex md:flex-row flex-col items-start justify-center mr-10 space-x-16">
        <div>
          <div className="md:w-48 md:h-48 w-40 h-40 rounded-full lg:left-3 relative left-[50%] bg-white mt-8">
            <img src={urlFor(image)} className="w-full h-full rounded-full" />
          </div>
        </div>
        <div className="md:mt-12 mt-2 justify-center items-center flex flex-col md:space-y-6">
          <h1 className="text-2xl text-center font-roboto font-bold dark:text-slate-300 tracking-wider text-gray-800">
            {name}
          </h1>
          <h6 className="text-center px-3 py-1 bg-white dark:bg-gray-700 dark:text-slate-200 rounded-lg text-lg text-gray-600 mt-3 font-semibold font-inter tracking-wide">
            {position}
          </h6>
